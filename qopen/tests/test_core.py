...
import numpy as np
from qopen.core import init_data, correct_sensitivities, run, run_cmdline
...
#        print(M0)
    ...
    def test_correct_sensitivities(self):
        r = {'E1':
             {'R': {'S1': [0.1, 100], 'S2': [1, 4]},
              'W': [10, 4]},
             'E2':
        ...
        r = {'events': r}
        cs = correct_sensitivities
        r2 = cs(deepcopy(r), use_sparse=True)
        r3 = cs(deepcopy(r), use_sparse=False)
