...
html_theme_options = {
    'description':
        'Seperation of intrinsic and scattering Q by envelope inversion',
    'show_powered_by': False,
    'page_width': '1240px',
    'extra_nav_links':
        {'Project on Github': 'https://github.com/trichter/qopen'}
}
...
latex_documents = [
    (master_doc, 'Qopen.tex', u'Qopen Documentation',
...
man_pages = [
    (master_doc, 'qopen', u'Qopen Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Qopen', u'Qopen Documentation',
     author, 'Qopen', 'One line description of project.',
     'Miscellaneous'),
]
